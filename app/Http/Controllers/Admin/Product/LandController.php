...
class LandController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.land.index', compact('products'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.land.create', compact('accounts', 'units'));
    }
    ...
    public function store(StoreProductRequest $request)
    {
        ...
        $data = array_merge($request->all(), ['cogs' => $cogs, 'profit' => $profit, 'type' => 'land']);
    ...
    public function edit(Product $product)
    {
        ...
        return view('admin.land.edit', compact('product', 'accounts'));
    }
    ...
    public function show(Product $product)
    {
        ...
        return view('admin.land.show', compact('product'));
    }
