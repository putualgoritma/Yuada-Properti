...
class ContructionCostController extends Controller
{
    use TraitModel;
    public function index(Request $request)
    {
        ...
        //return $orders;
        return view('admin.contructioncost.index', compact('orders', 'customers'));
    }
    public function create(Request $request)
    {

        // dd($request->project_id);
        $last_code = $this->get_last_code('contructioncost');
        ...
        $accounts = Account::select('*')
            ...
            ->get();
        return view('admin.contructioncost.create', compact('products', 'accounts', 'code', 'projects'));
    }
    public function store(Request $request)
    {
        ...
        $data = array_merge($request->all(), [
            'customers_id' => null,
            'total' => $total,
            'type' => 'manufactur_process',
            'category' => 'material',
            'project_type' => 'contruction',
            'status' => 'approved',
            'ledgers_id' => $ledger_id,
            'payment_type' => '',
        ...
        return redirect()->route('admin.contructioncost.index');
    }
}
