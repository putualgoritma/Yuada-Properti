...
@can('order_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route("admin.salepayment.create") }}">
                ...
                <table class=" table table-bordered table-striped table-hover datatable datatable-Order ajaxTable datatable-orders"">
                    <thead>
                        <tr>
                            ...
                            <th>
                                {{-- {{ trans('global.order.fields.customers_name') }} --}}
                                Pelanggan
                            </th>
                            <th>
                                {{-- {{ trans('global.order.fields.amount') }} --}}
                                Jumlah Pembayaran(DP)
                            </th>
                            <th>
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    aaSorting: [],
    ajax: {
      url: "{{ route('admin.salepayment.index') }}",
      dataType: "json",
      headers: {'x-csrf-token': _token},
      method: 'GET',
      data: {
