...
<div class="card">
    ...
    <div class="form-group">
        ...
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable ajaxTable datatable-receivables">
                <thead>
                    <tr>
                        <th width="10">
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    aaSorting: [],
    ajax: {
      url: "{{ route('admin.receivables.index') }}",
      data: {
  ...
  $('.datatable-receivables').DataTable(dtOverrideGlobals);
