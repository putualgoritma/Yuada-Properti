...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('global.receivable.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.receivables.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group {{ $errors->has('customer_id') ? 'has-error' : '' }}">
                <label for="customer_id">{{ trans('global.receivable.fields.customer_id') }}*</label>
                ...
                @endif
                <p class="helper-block">
                    {{ trans('global.receivable.fields.customer_id_helper') }}
                </p>
            </div>
            ...
            <div class="form-group {{ $errors->has('account_id') ? 'has-error' : '' }}">
                <label for="account_id">{{ trans('global.receivable.fields.account_id') }}*</label>
            ...
            <div class="form-group {{ $errors->has('account_pay') ? 'has-error' : '' }}">
                <label for="account_pay">{{ trans('global.receivable.fields.account_pay') }}*</label>
                ...
                @endif
                <p class="helper-block">
                    {{ trans('global.receivable.fields.account_pay_helper') }}
                </p>
            </div>
