...
@can('order_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route("admin.contructioncost.create") }}">
                {{-- {{ trans('global.add') }} {{ trans('global.order.title_singular') }} --}}
                Tambah Biaya Kontruksi
            </a>
        </div>
    </div>
@endcan
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    aaSorting: [],
    ajax: {
      url: "{{ route('admin.contructioncost.index') }}",
      dataType: "json",
      headers: {'x-csrf-token': _token},
      method: 'GET',
      data: {
    ...
    columns: [
        ...
        { data: 'project', name: 'project', searchable: false  },
