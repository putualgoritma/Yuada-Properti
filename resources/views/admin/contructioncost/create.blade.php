...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.contructioncost.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <table class="table" id="products_table">
                        ...
                        <tbody>
                            ...
                            <tr id="product{{ $index }}">
                                ...
                                <td>
                                    <input type="text" name="surface_area[]" class="form-control surface_area_list" value="" readonly />
                                </td>
                                <td>
                                    <input type="text" name="building_area[]" class="form-control building_area_list" value="" readonly />
                                </td>
                                <td>
                                    <input type="text" name="more_land[]" class="form-control more_land_list" value="" readonly />
                                </td>
                                <td>
