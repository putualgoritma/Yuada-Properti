...
@section('content')
    ...
    <form  action="{{ route("admin.statistik.memberOrder") }}" method="GET"  >
        {{-- @csrf --}}
        <div class="col-md-12 ">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="type" id="type" class="form-control" >
                            <option value="ro"  {{ isset($_GET['type']) && $_GET['type'] == 'ro'? 'selected' : '' }}>Repeat Order</option>
                            <option value="am"  {{ isset($_GET['type']) && $_GET['type'] == 'am'? 'selected' : '' }}>Auto Maintain</option>
                        </select>
                    </div>
                </div>
