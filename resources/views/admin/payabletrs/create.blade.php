...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('global.payable.fields.trs') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.payables.storeTrs") }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group {{ $errors->has('account_id') ? 'has-error' : '' }}">
                <label for="account_id">{{ trans('global.payable.fields.account_pay') }}*</label>
