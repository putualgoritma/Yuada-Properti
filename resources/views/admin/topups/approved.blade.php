...
<div class="card">
    ...
    Setujui {{ trans('global.topup.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.topups.approvedprocess") }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')   
                     
            <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
            <div class="checkbox">
            <label>Setujui Topup?</label>
