...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('global.saleretur.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.salereturs.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group {{ $errors->has('register') ? 'has-error' : '' }}">
                <label for="register">{{ trans('global.saleretur.fields.register') }}*</label>
                <input type="date" id="register" name="register" class="form-control" value="{{ old('register', isset($saleretur) ? $saleretur->register : date('Y-m-d')) }}" required>
                ...
                <p class="helper-block">
                    {{ trans('global.saleretur.fields.register_helper') }}
                </p>
            </div>
            <div class="form-group {{ $errors->has('code') ? 'has-error' : '' }}">
                <label for="code">{{ trans('global.saleretur.fields.code') }}*</label>
                <input type="text" id="code" name="code" class="form-control" value="{{ old('code', isset($saleretur) ? $saleretur->code : $code) }}" required>
                @if($errors->has('code'))
                    <em class="invalid-feedback">
                        {{ $errors->first('code') }}
                    </em>
                @endif
                <p class="helper-block">
                    {{ trans('global.saleretur.fields.code_helper') }}
                </p>
            </div>
            <div class="form-group {{ $errors->has('customers_id') ? 'has-error' : '' }}">
                <label for="customers_id">{{ trans('global.saleretur.fields.customers_id') }}*</label>
                ...
                @endif
                <p class="helper-block">
                    {{ trans('global.saleretur.fields.customers_id_helper') }}
                </p>
            </div>
            <div class="form-group {{ $errors->has('memo') ? 'has-error' : '' }}">
                <label for="memo">{{ trans('global.saleretur.fields.memo') }}</label>
                ...
                @endif
                <p class="helper-block">
                    {{ trans('global.saleretur.fields.memo_helper') }}
                </p>
            </div>

            <div class="form-group {{ $errors->has('accounts_id') ? 'has-error' : '' }}">
                <label for="accounts_id">{{ trans('global.saleretur.fields.accounts_id') }}*</label>
                ...
                @endif
                <p class="helper-block">
                    {{ trans('global.saleretur.fields.accounts_id_helper') }}
                </p>
            </div>
