...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('global.order.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.salereturs.update", [$order->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="form-group {{ $errors->has('customer_name') ? 'has-error' : '' }}">
                <label for="customer_name">{{ trans('global.order.fields.customer_name') }}*</label>
                ...
                <p class="helper-block">
                    {{ trans('global.order.fields.customer_name_helper') }}
                </p>
            </div>
            <div class="form-group {{ $errors->has('customer_email') ? 'has-error' : '' }}">
                <label for="customer_email">{{ trans('global.order.fields.customer_email') }}</label>
                ...
                @endif
                <p class="helper-block">
                    {{ trans('global.order.fields.customer_email_helper') }}
                </p>
            </div>
            <div class="card">
                <div class="card-header">
